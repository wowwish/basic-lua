...
function display_menu()
  ...
  print("+----------------------------------")
  print("| 1.Generate random enemy position on 2D window")
  print("| 2.Distance from enemy to player at centre of 2D window")
  print("| 3.Get angle from enemy to player who is at centre of 2D window")
  print("| 4.Exit")
  print("+----------------------------------")
end
...
while user_option ~= 4 do
  ...
  user_option = io.read("*n") -- "*n" is used to tell the function to read as a number from the user input
  ...
  if user_option == 3 then
    -- math.atan2 returns the inverse tangent (angle) of the tangent calculated by opposite/adjacent in radians
